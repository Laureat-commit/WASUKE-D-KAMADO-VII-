module.exports = {
    approval: {
        num: "24177059320", // Nomor yang diizinkan untuk menyetujui script
        text: "setujui", // Kata kunci untuk menyetujui script
        set: "ANDA HARUS MENDAPATKAN PERSETUJUAN OLEH DANTZY",
        greet: "ANDA TELAH BERHASIL DI SETUJUI SILAHKAN GUNAKAN SEBAIK MUNGKIN"
    },
    creatorScript: '24177059320', // Jangan Hapus Ini
